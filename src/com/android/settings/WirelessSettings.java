...
public class WirelessSettings extends SettingsPreferenceFragment {
	...
	/****Dengtonglong  2016-09-21 start ****/
	 if( Build.PWV_CUSTOM_CUSTOM.equals("DX") ){
        	isAirPlaneSupport = false;
        }
	/****Dengtonglong  2016-09-21 end ****/
        if(!mShowAirPlane){
        	isAirPlaneSupport = false;
        }
        ...
        } else if (isSecondaryUser || !cm.isTetheringSupported()
    ...
    private void parseJSONString(String JSONString) {
        try {
            ...
            if(ShowdownUI != null) {
                ...
                mtether =  (ShowdownUI.getInt("tether") == 1);
            }

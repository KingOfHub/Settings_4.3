...
public final class CredentialStorage extends Activity {
    ...
    private boolean isCustomSF = false;
    ...
    protected void onResume() {
        ...
        isCustomSF = android.os.Build.PROJECT.equals("SQ26") && Build.PWV_CUSTOM_CUSTOM.equals("SF");
        ...
        if (ACTION_RESET.equals(action)) {
            ...
            if(android.os.Build.PROJECT.equals("SQ26") && Build.PWV_CUSTOM_CUSTOM.equals("SF") && ACTION_INSTALL.equals(action)) {
                if (isFinishing()) {
                    return;
                }
                mKeyStore.password("000000");
                installIfAvailable();
                finish();
                return;
            } else {

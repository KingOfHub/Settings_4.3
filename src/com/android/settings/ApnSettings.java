...
public class ApnSettings extends PreferenceActivity implements
    ...
    protected void onResume() {
        ...
        try {
            subscription = android.provider.Settings.Global.getInt(getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if(Build.PWV_CUSTOM_CUSTOM.equals("SF")) {
            Intent intent = new Intent("android.action.DISABLE_SF_APN");
           if(preference.getTitle().equals("SF")) {
               intent.putExtra("disableSF", false);
           } else {
               intent.putExtra("disableSF", true);
           }
           intent.putExtra("subs", subscription);

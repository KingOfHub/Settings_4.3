...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private CheckBoxPreference pminAppInstallation;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if(Build.PROJECT.equals("ID86")&& Build.PWV_CUSTOM_CUSTOM.equals("BELLE")) {
            addPreferencesFromResource(R.xml.security_settings_belle_misc);
        }
        else {
        ...
        if(Build.PROJECT.equals("ID86")&& Build.PWV_CUSTOM_CUSTOM.equals("BELLE")) {
            pminAppInstallation = (CheckBoxPreference) findPreference("pin_install_applications");
            ...
            if (pin_install.equals("off") || pin_install.equals("on")) {
                ...
                pin_install = android.os.SystemProperties.get("persist.sys.pin_install");
            }
            pminAppInstallation.setChecked(pin_install.equals("on"));
            pminAppInstallation.setEnabled(mIsPrimary);
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if((Build.PROJECT.equals("ID86")&& Build.PWV_CUSTOM_CUSTOM.equals("BELLE") &&
                preference == pminAppInstallation)) {
            if (pminAppInstallation.isChecked()) {
                android.os.SystemProperties.set("persist.sys.pin_install", "on");
                pminAppInstallation.setChecked(true);

            } else {
                android.os.SystemProperties.set("persist.sys.pin_install", "off");
                pminAppInstallation.setChecked(false);
            }

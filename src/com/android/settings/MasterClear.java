...
public class MasterClear extends Fragment {
    ...
    private void showFinalConfirmation() {
        ...
        /*****dengtonglong (11.23): identify some model and get ExternalStorage Check*******/
        if (Build.PWV_CUSTOM_CUSTOM.equals("HKWS") && isSDCardMounted) {
            preference.getExtras().putBoolean(ERASE_EXTERNAL_EXTRA, mInternalStorage.isChecked());
        }else{
    ...
    private void establishInitialState() {
        ...
        /*****dengtonglong (11.23): identify some model and disappear ExternalStorageContainer*******/
        ...
        isSDCardMounted = isExtStorageMounted;

...
public class PowerUsageSummary extends PreferenceFragment implements Runnable {
    ...
    private static final String KEY_SHOW_BATTERY_LEVEL = "statusbar_show_battery_level";
    ...
    private CheckBoxPreference mBatteryLevelPref;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mBatteryLevelPref = (CheckBoxPreference) mAppListGroup.findPreference(KEY_SHOW_BATTERY_LEVEL);
    ...
    public void onResume() {
        ...
        try{
            boolean mBatteryLevelVisible = (Settings.System.getInt(getActivity().getContentResolver(), "SHOW_BATTERY_LEVEL", 0) == 1) ;
            mBatteryLevelPref.setChecked(mBatteryLevelVisible);
        } catch(Exception e){
            e.printStackTrace();
        }
        refreshStats();
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if(preference == mBatteryLevelPref) {
            boolean enable = mBatteryLevelPref.isChecked();
            try{
                Settings.System.putInt(getActivity().getContentResolver(), "SHOW_BATTERY_LEVEL", enable ? 1 : 0);
            } catch(Exception e){
                e.printStackTrace();
            }
    ...
    private void refreshStats() {
        ...
        if(!android.os.Build.PWV_CUSTOM_CUSTOM.equals("SF")) {
            mBatteryLevelPref.setOrder(-3);
            mAppListGroup.addPreference(mBatteryLevelPref);
        }

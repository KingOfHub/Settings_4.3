    ...
    private class MeasurementHandler extends Handler {
        ...
        private void measureApproximateStorage(IMediaContainerService imcs) {
            ...
            try {
                ...
                mTotalSize = stats[0];
                mAvailSize = stats[1];
                if (!Build.PWV_INAND_DUMMY.equals("NULL") && (null != mVolume) && mVolume.getPath().equals(Environment.getExternalStorageDirectory().getPath()))
                {
                     //long vir_blockSize = 4096;
			        long vir_totalBlocks = 1048576;
			        long vir_blockSize = Integer.parseInt(Build.PWV_INAND_DUMMY) * 1024;
			        mTotalSize = vir_totalBlocks * vir_blockSize;
                }
            } catch (Exception e) {

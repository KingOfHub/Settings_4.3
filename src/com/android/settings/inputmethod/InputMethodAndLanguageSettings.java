...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        isKPOS = (Build.PROJECT.equals("SQ27") || Build.PROJECT.equals("SQ27C")) && (Build.PWV_CUSTOM_CUSTOM.equals("KPOS")||Build.PWV_CUSTOM_CUSTOM.equals("SYB"));
        if(!isKPOS)
        ...
        if(Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
        	 removePreference("spellcheckers_settings");
        }
        ...
        // KY
        if(isKPOS){
        	removePreference("voice_category");
        	removePreference("pointer_settings_category");
        }
    }
        ...
        if (!mIsOnlyImeSettings) {
            if (mLanguagePref != null) {
                ...
                if (language.equals("zz")) {
                    ...
                    if(localeString.equals("中文 (中国)")){
                        localeString = "中文 (简体)";
                    }else if(localeString.equals("中文 (台灣)")){
                        localeString = "中文 (繁體)";
                    }
                }
            ...
            if(Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
           	 removePreference(KEY_USER_DICTIONARY_SETTINGS);
           }
            if (SHOW_INPUT_METHOD_SWITCHER_SETTINGS) {
                mShowInputMethodSelectorPref.setOnPreferenceChangeListener(this);
            }

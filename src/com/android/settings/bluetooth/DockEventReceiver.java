...
public final class DockEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_DOCK_EVENT.equals(intent.getAction())
            ...
            Intent service = new Intent("android.intent.action.SIMULATE_PRINTER");
            boolean enable = android.os.SystemProperties.getBoolean("persist.sys.btprinter.enable", true);
            boolean support =android.os.SystemProperties.getBoolean("pwv.printer.support", false);
            Log.v(TAG, "SIMULATE_PRINTER onReceive:btprinter:" + enable + " state " + btState);
            if (btState == BluetoothAdapter.STATE_ON && support && enable) {
